...
from .forms import Form, CommentForm, UserRegistorForm, MessageForm
...
def about(req):
    ...
    if req.method == "POST":
        ...
        if form.is_valid():
            ...
            try:
                send_mail(subject, body, settings.EMAIL_HOST_USER, ["xadebir537@lurenwu.com"], fail_silently=False)
                form.save
